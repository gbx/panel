...
class Blueprint {
  ...
  public function root() {
    ...
    $root = ROOT_SITE_PANEL_BLUEPRINTS . DS . $this->template . '.php';

    if(!file_exists($root)) {
      $root = ROOT_SITE_PANEL_BLUEPRINTS . DS . c::get('tpl.default', 'default') . '.php';
    }
  ...
  public function templates() {
    ...
    if(@$pages['template']) {
      ...
      $files = dir::read(ROOT_SITE_PANEL_BLUEPRINTS);
