...
$.widget('kirby.wysiwtf', {
  ...
  _create : function() {
    ...
    this.field = this.element.parents('.form-field');
    this.bar   = this.field.find('.form-field-input-buttons');
...
$.fn.form = function() {
  ...
  return this.each(function() {
    ...
    if($.fn.autosize) $textarea.autosize();
    if($.fn.wysiwtf)  $textarea.wysiwtf();

    $form.find('.form-field').on({
      'click' : function() {
        $(this).find('.form-field-input').focus();
      },
      'fakeFocus' : function() {
        $form.find('.form-field.is-focused').not(this).trigger('fakeBlur');
        $(this).addClass('is-focused');
        $(this).parents('.form-fieldgroup').trigger('fakeFocus');
      },
      'fakeBlur' : function() {
    ...
    $form.find('.form-field-input').on({
      'focus' : function() {        
        $(this).parents('.form-field').trigger('fakeFocus');    
      },
      'blur' : function() {    
        $(this).parents('.form-field').trigger('fakeBlur');    
      }
    });
